...
### Fixed
- Calendar views once again show past events for historical context
- Calendar day and hover interactions now open the relevant term and dialog so events are fully clickable
